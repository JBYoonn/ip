        ...
        while (true) {
            ...
            if (userInput.startsWith("deadline ")) {
                ...
                if (parts.length != 2 || parts[0].isBlank() || parts[1].isBlank()) {
                    printError(line, "Format: deadline <description> /by <when>");
                    continue;
                }
                ...
                if (partsFrom.length != 2 || partsTo.length != 2
                    ...
                    printError(line, "Format: event <description> /from <when> /to <when>");
                    continue;
                }
                ...
                System.out.println(line);
                System.out.println("Invalid input. Here is a list of commands:");
